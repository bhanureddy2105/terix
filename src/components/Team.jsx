...
export default function Team() {
    ...
    return (
        <div className="bg-zinc-200 py-12 md:py-24 lg:py-20">
            <div className="mx-auto grid max-w-7xl grid-cols-1 gap-y-20 px-12 lg:px-16 xl:grid-cols-3">
                {/* {isLargeScreen && <div className="flex flex-row space-x-20 lg:transform lg:-rotate-90">
                    <p className="text-7xl text-black team-color">T</p>
                    <p className="text-7xl text-black team-color">E</p>
                    <p className="text-7xl text-black team-color">A</p>
                    <p className="text-7xl text-black team-color">M</p>
                </div>} */}
