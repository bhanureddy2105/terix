    ...
    return (
        <div className="p-16">
                    ...
                    <div className="flex flex-row justify-start gap-x-36">
                        <div className="flex flex-col w-1/3">
                            ...
                            <div className="pt-4 pb-12 px-4 science-card-color">
                                ...
                                <p className="pb-6">Et netus et malesuada fames ac turpis egestas. Nunc sed blandit libero volutpat sed cras ornare arcu.</p>
                                <a className="text-center" href="">Read the article</a>
                            </div>
                        </div>
                        <div className="flex flex-col w-1/3">
                            <img src={cardImage} alt="" srcset="" />
            ...
            <div>
                ...
                <div className="flex flex-row justify-between gap-x-36 my-60">
                    <div className="flex flex-col w-1/2">
